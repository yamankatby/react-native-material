...
const icon = (name: any) => (props: { size: number; color: string }) => <Icon name={name} {...props} />;
const iconButton =
  (...names: any[]) =>
    (props: { size: number; color: string }) =>
      names.map(name => <IconButton {...props}
                                    icon={<Icon name={name} color={props.color} size={props.size / 2} />} />);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: palette.background }}>
      <Appbar
        ...
        trailing={iconButton("heart", "magnify", "dots-vertical")}
      />
      <View style={{ flex: 1, padding: 16 }}>
        <TextInput label="Placeholder" />
        <TextInput label="Placeholder" variant="outlined" leading={<ActivityIndicator />} />
        <TextInput label="Placeholder" assistiveText="Hi, some error looks it is appered" />
        <TextInput label="Placeholder" />
      ...
      <Appbar
        variant="bottom"
        leading={iconButton("menu")}
        trailing={iconButton("magnify", "dots-vertical")}
...
//       <ScrollView horizontal={false} style={{ flexDirection: "row", flexWrap: "wrap" }}>
//         <View style={{ margin: 12, width: 330 }}>
//           <Appbar title="Page title" />
//
//           <Appbar title="Page title" subtitle="Lorem ipsum dolor." style={{ marginTop: 24 }} />
//
//           <Appbar subtitle="Lorem ipsum dolor." style={{ marginTop: 24 }} />
//
//           <Appbar
//             title="Page title"
//             subtitle="Lorem ipsum dolor."
...
//           </Appbar>
//         </View>
//         <View style={{ margin: 24, width: 330 }}>
//           <ListItem
//             title="Lorem ipsum."
...
//         <View style={{ margin: 24, width: 330 }}>
//           <TextInput />
//           <TextInput label="Label" style={{ marginTop: 24, width: 330 }} />
